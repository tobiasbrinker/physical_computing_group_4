...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            BluetoothGattService mCustomService = mBluetoothGatt.getService(CUBE_SERVICE_UUID);
    ...
    public void readCustomCharacteristic() {
       ...
       for(BluetoothGattCharacteristic c : a) {
        ...
        BluetoothGattCharacteristic mReadCharacteristic = mCustomService.getCharacteristic(CUBE_RETRIEVE_UUID);
    ...
    public void writeCustomCharacteristic(byte[] value) {
        ...
        BluetoothGattService Service = mBluetoothGatt.getService(CUBE_SERVICE_UUID);
        if (Service == null) {
            Log.e(TAG, "service not found!");
            return;
        }
        BluetoothGattCharacteristic charac = Service
                .getCharacteristic(CUBE_SEND_UUID);
        if (charac == null) {
